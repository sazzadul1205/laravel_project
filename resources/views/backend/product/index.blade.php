            ...
            <div class="card m-b-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-black mb-0">Product List</h4>
                        <a href="{{ url('product/create') }}" class="btn btn-primary fw-semibold">
                            ...
                            @foreach ($data as $product)
                                <tr>
                                   <form method="post" action="{{ route('product.destroy', $product->id) }}" >
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ route('product.edit', $product->id) }}"><i class="bi bi-pencil-square"></i> Edit</a>
                                        <button 
